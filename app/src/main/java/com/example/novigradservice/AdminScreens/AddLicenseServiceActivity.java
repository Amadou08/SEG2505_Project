...
public class AddLicenseServiceActivity extends AppCompatActivity {
   ...
   // StorageReference mRef;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_lience_service);
        licenseTypeList.clear();
        licenseTypeList.add("G1");
        licenseTypeList.add("G2");
        licenseTypeList.add("G");
        spinner=findViewById(R.id.spinner);
        arrayAdapter = new ArrayAdapter(this,android.R.layout.simple_spinner_item,licenseTypeList);
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int position, long l) {
                category =  licenseTypeList.get(position);
            }
    ...
    public  void addImage(){
        Dexter.withActivity(AddLicenseServiceActivity.this)
    ...
    private void showSettingsDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(AddLicenseServiceActivity.this);
...
//
    ...
    private void openSettings() {
        ...
        Uri uri = Uri.fromParts("package",AddLicenseServiceActivity.this.getPackageName(), null);
        intent.setData(uri);
    ...
    private String getFileEx(Uri uri){
        ContentResolver cr=AddLicenseServiceActivity.this.getContentResolver();
