...
public class AddPhotoIdServiceActivity extends AppCompatActivity {
    ...
    public void saveRecord(View view){
        ...
        else if(docImgUri==null&&customerImgUri==null){
            String id = null;
            try {
                ...
                myRef.child("CustomerImage").setValue("empty");
                loadingDialog.dismiss();
                finish();
            } catch (Exception e) {
                throw new RuntimeException(e);
            }
        } else if(customerImgUri!=null&&docImgUri==null){
            uploadRecord("empty");
        }
        else {
        ...
        storageReference.putFile(docImgUri)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        loadingDialog.dismiss();
                        Toast.makeText(AddPhotoIdServiceActivity.this, e.getMessage(), Toast.LENGTH_LONG).show();
                    }
                })
    ...
    public void uploadRecord(String addressDocUrl){
        loadingDialog.show();
        StorageReference storageReference = mRef.child(System.currentTimeMillis() + "." + getFileEx(customerImgUri));
        storageReference.putFile(customerImgUri)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    @RequiresApi(api = Build.VERSION_CODES.GINGERBREAD)
                    @Override
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
